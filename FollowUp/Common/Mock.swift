...
//    @Persisted var _id: ObjectId = ObjectId()
    ...
    @Persisted var firstAddedLocation: LocationSample? = .init(arrivalDate: .now, latitude: faker.address.latitude(), longitude: faker.address.longitude(), horizontalAccuracy: 1)
